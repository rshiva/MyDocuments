      ...
      <tr>
        <td colspan="3" valign="top" class="pad_left">
		  <ul class="news-two">
             ...
             <%=WebContent("Qianbo_NewsSort",request.QueryString("SortID"),"")%>
		</td>
      </tr>
    </table></td>
  </tr>
...
While Not rs.EOF
    ...
    Response.Write "<li><span class=""tit""><img src=""images/news_ico.gif"" width=""3"" height=""5"" style=""vertical-align:middle"" /> <a href="""&AutoLink&""">"&rs("NewsName")&"</a></span><span class=""date"">"&FormatDate(rs("Addtime"), 13)&"</span></li>"&vbCrLf
    rs.movenext
Wend
Else
