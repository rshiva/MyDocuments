...
<table width="975"  border="0" align="center" cellpadding="0" cellspacing="0" class="margin">
  <tr>
    ...
    <td width="673" height="28" colspan="3" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        <td colspan="3">　<img src="images/weizhi.gif" width="14" height="14" style="vertical-align:middle;" />&nbsp;您当前的位置：<a href="index.asp">爱克思伦企业管理首页</a> → <a href="service.asp">服务范围</a> </td>
      </tr>
      <tr>
        <td width="51" height="27" align="center" valign="top" bgcolor="#3D8EEA"><img src="images/right_ico.gif" width="28" height="27" /></td>
        <td width="411" valign="top" bgcolor="#3D8EEA"><h2>服务范围</h2></td>
      ...
      <tr>
        <td colspan="3" valign="top" class="pad_left">
		  <ul class="news-two">
             ...
             <%=WebContent("Qianbo_OthersSort",request.QueryString("SortID"),"")%>
		</td>
      </tr>
    </table></td>
  </tr>
...
rs.Open sql, conn, 0, 1
While Not rs.EOF
    AutoLink = "SerView.Asp?ID="&rs("ID")&""
    Response.Write "<li><span class=""tit""><img src=""images/news_ico.gif"" width=""3"" height=""5"" style=""vertical-align:middle"" /> <a href="""&AutoLink&""">"&rs("OthersName")&"</a></span><span class=""date"">"&FormatDate(rs("Addtime"), 13)&"</span></li>"&vbCrLf
    rs.movenext
Wend
Else
