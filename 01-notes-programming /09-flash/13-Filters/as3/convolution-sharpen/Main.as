package 
{
	...
	public class Main extends Sprite 
	{
		...
		{	
			// apply sharpening effect by Convolution Filter
			applySharpening();
		}
		
		private function applySharpening():void
		{
			...
			function getFilter(event:Event):void
			{
				...
				*/
				...
				var _convolutionFilter:ConvolutionFilter = new ConvolutionFilter(3, 3, [0, -1, 0, -1, 10, -1, 0, -1, 0], 5);
