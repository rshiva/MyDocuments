package 
{
	...
	public class Main extends Sprite 
	{
		...
		{	
			// Apply ColorMatrix Filter with digital negitive matrix
			digitalNegative();
		}
		
		private function digitalNegative():void
		{
			...
			function getFilter(event:Event):void
			{
				...
				// create ColorMatrix Filter and use ascb.filters.ColorMatrixArrays.DIGITAL_NEGATIVE constant
				var _colorMartixFilter:ColorMatrixFilter = new ColorMatrixFilter(ColorMatrixArrays.DIGITAL_NEGATIVE);
