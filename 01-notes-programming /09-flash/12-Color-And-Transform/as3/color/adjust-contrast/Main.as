package 
{
	...
	public class Main extends Sprite 
	{
		...
		{	
			// change brightness by color Matrix filter 
			changeContrast();
		}
		...
		private function changeContrast():void
		{
			...
			function getFilter(event:Event):void
			{
				...
				// use the ascb.filters.ColorMatrixArrays.getContrastArray( ) method to construct a contrast array given the contrast value. The effective range for the contrast value is from 0 to 1
				var _colorMartixFilter:ColorMatrixFilter = new ColorMatrixFilter(ColorMatrixArrays.getContrastArray(1));
