...
<div class="yToolbar"> 
  ...
  <div class="TBSep"></div>
  <div class="Btn" TITLE="保存"	LANGUAGE="javascript" onclick="Insermenu('2005-12-21 3:13:17')"> 
...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="插入下拉菜单" LANGUAGE="javascript" onclick="Insermenu('2005-12-21 3:13:17')"> 
...
<div class="yToolbar"> 
  ...
  <div class="Btn" TITLE="插入特殊符号" LANGUAGE="javascript" onclick="Insertlr('editor_tsfh.htm',300,200,11597000.00023)"><img class="Ico" src="images/editor/symbol.gif" ></div>
...
<iframe class="HtmlEdit" ID="HtmlEdit" src="ProductContent.asp?Action=Down&ID=9" MARGINHEIGHT="1" MARGINWIDTH="1" style="width=100%; height=266;"> </iframe>
