        ...
        <tr> 
          <td class="tdbg_left"  width="190" height="179" valign="top" > <table width="100%" border="0" cellspacing="0" cellpadding="0">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
              ...
              <tr> 
                <td height="20"> <div align="center"><a href="News.asp">企 业 新 
                    闻</a></div></td>
              </tr>
              <TR> 
                <TD 
              ...
              <tr> 
                <td height="20"> <div align="center"><a href="yeNews.asp">业 内 
                    资 讯</a></div></td>
              </tr>
              <TR> 
                <TD 
              ...
              <tr> 
                <td height="206" valign="top"> <table width="100%" border="0" cellspacing="0" cellpadding="0">
                  ...
                  height=1> <table width="100%" height="19" border="0" align="center" cellpadding="0" cellspacing="0">
                          <tr> 
                            <td width="22%" height="18" bgcolor="#eeeeee">&nbsp;&nbsp;首页 
                              &gt;&gt; 业内资讯</td>
                            <td width="78%" bgcolor="#eeeeee">&nbsp; </td>
                          </tr>
                          <tr> 
                        ...
                        <table width="100%" border="0" align="center" cellpadding="0" cellspacing="3" bgcolor="#FBFEFF">
                          ...
                          <tr> 
                            <td><script language="javascript" src="owen.asp?owen1=业内资讯&n=20"></script> 
                            </td>
                          </tr>
                          <tr> 
