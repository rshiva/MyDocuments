...
Response.Write("<script language=""JavaScript"">alert(""错误：您没输入学历，请返回检查！！"");history.go(-1);</script>")
response.end
end if
If request.form("specialty")="" Then
Response.Write("<script language=""JavaScript"">alert(""错误：您没输入专业，请返回检查！！"");history.go(-1);</script>")
response.end
end if
...
Response.Write("<script language=""JavaScript"">alert(""错误：您没输入电话，请返回检查！！"");history.go(-1);</script>")
response.end
end if
