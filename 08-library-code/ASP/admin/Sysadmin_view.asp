...
<table cellpadding="2" cellspacing="1" border="0" width="95%" align="center" class="table_southidc">
    ...
    <td class="back_southidc" colspan="2" height="25" align="center"> 经营视窗后台管理系统&nbsp;Ver7.0</td>
	</tr>
	<tr class="tr_southidc">
		
    <td width="20%" height="19">产品修改</td>
		
    <td width="80%"><a target="_blank" href="http://www.yagn.cn/"></a></td>
	</tr>
	<tr class="tr_southidc">
...
<table cellspacing=0 cellpadding=0 width=95% align=center><tr>
    <td align=middle>Script Execution Time:<%=fix((timer()-startime)*1000)%>ms</td></tr></table>
