    ...
    <td align="center" valign="top"> <br>
      <table width="620" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
        <tr class="back_southidc">
          <td height="25" align="center" bgcolor="#A4B6D7"><strong>下 
        载 管 理</strong></td>
        </tr>
        <tr class="title"> 
...
%>
      ...
      <form name="del" method="Post" action="Down_ArticleDel.asp" onSubmit="return ConfirmDel();">
        <table width="620" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
          <tr> 
...
sub showContent
    ...
    i=0
%>
        <table width="620" border="0" cellpadding="2" cellspacing="1" class="table_southidc" style="word-break:break-all">
          <tr bgcolor="#99CCFF" class="title"> 
            <td width="36" height="25" align="center">选中</td>
            <td width="40"  height="25" align="center">ID</td>
            <td width="246" align="center" >下载标题</td>
          ...
          <%do while not rs.eof%>
          <tr class="tdbg"> 
            <td width="36" height="22" align="center" class="tr_southidc"> 
              <input name='ID' type='checkbox' onClick="unselectall()" id="ID" value='<%=cstr(rs("ID"))%>'>
            </td>
            <td width="40" align="center" class="tr_southidc"><%=rs("id")%></td>
            <td class="tr_southidc"><a href="../DownloadShow.asp?ID=<%=rs("id")%>" target="_blank"><%=left(rs("title"),18)%></a></td>
            <td class="tr_southidc">
<div align="center"><%=rs("BigClassName")%></div></td>
            <td class="tr_southidc">
<div align="center"><%=rs("SmallClassName")%></div></td>
            <td align="center" class="tr_southidc"><%= FormatDateTime(rs("infotime"),2) %> </td>
            <td width="68" align="center" class="tr_southidc"> <a href="Down_modi.asp?ID=<%=rs("id")%>">修改</a> 
