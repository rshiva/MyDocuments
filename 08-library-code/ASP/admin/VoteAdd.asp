      ...
      <form method="POST" action="VoteAdd.asp">
        <table width="560" border="0" align="center" cellpadding="2" cellspacing="1" Class="table_southidc">
          <tr class="back_southidc">
            <td height="22" colspan="4" align="center" bgcolor="#A4B6D7"><strong>添 加 调 查</strong></td>
          </tr>
          <tr class="tdbg"> 
            <td width="81" height="22" align="right" bgcolor="#E3E3E3">主题：</td>
            <td colspan="3" bgcolor="#E3E3E3"> <input name="Title" type="text" size="45" maxlength="50"></td>
          </tr>
          <%
	for i=1 to 8%>
          <tr class="tdbg"> 
            <td height="22" align="right" bgcolor="#E3E3E3">选项<%=i%>：</td>
            <td width="281" bgcolor="#E3E3E3"> <input type="text" name="select<%=i%>" size="36">            </td>
            <td width="41" align="right" bgcolor="#E3E3E3">票数：</td>
            <td width="87" bgcolor="#E3E3E3"> <input type="text" name="answer<%=i%>" size="5"></td>
          </tr>
          <%next%>
          <tr class="tdbg"> 
            <td height="22" align="right" bgcolor="#E3E3E3">调查类型：</td>
