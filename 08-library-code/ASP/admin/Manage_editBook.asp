          ...
          <form method="post" action="Manage_editbook.asp?mark=southidc">
            ...
            <td bgcolor="#FFFFFF"><div align="center"> 
                <table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#ECF5FF" class="table_southidc">
                  <tr bgcolor="#E3E3E3"> 
                    <td width="27%" height="25"> <div align="center">公告标题:</div></td>
                    <td width="73%"> <input name="Title" type="text" id="Title" value="<%=rs("Title")%>" size="45" maxlength="100"> 
                    </td>
                  </tr>
                  <tr bgcolor="#E3E3E3"> 
                    <td height="22"> <div align="center">公告内容:</div></td>
                    <td><textarea rows="8" name="Content" cols="45"><%=rs("Content")%></textarea>                    </td>
                  </tr>
                  <tr> 
