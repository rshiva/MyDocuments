...
<table width="100%" height="100%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr> 
    <td width="1217" align="center" valign="top"><p align="center">&nbsp;</p>
      <table width="560" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
        <tr class="title">
          <td height="25" align="center" bgcolor="A4B6D7" class="back_southidc"><strong>产 
          品 管 理</strong></td>
        </tr>
        <tr class="title"> 
...
%>
      ...
      <form name="del" method="Post" action="ProductDel.asp" onSubmit="return ConfirmDel();">
        <table width="560" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
          <tr bgcolor="A4B6D7"> 
            <td height="25" valign="middle" bgcolor="A4B6D7"><a href="ProductManage.asp">&nbsp;产品管理</a> &gt;&gt; 
              <%
...
sub showContent
    ...
    i=0
%>
        <table width="560" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000" class="table_southidc" style="word-break:break-all">
          <tr bgcolor="A4B6D7" class="title"> 
            <td width="47" height="25" align="center" bgcolor="#99CCFF"><strong>选中</strong></td>
            <td width="28"  height="25" align="center" bgcolor="#99CCFF"><strong>ID</strong></td>
            <td width="82" align="center" bgcolor="#99CCFF"><strong>产品编号</strong></td>
            <td width="231" align="center" bgcolor="#99CCFF" ><strong>产品名称</strong></td>
            <td width="68" align="center" bgcolor="#99CCFF" ><strong>加入时间</strong></td>
            <td width="68" align="center" bgcolor="#99CCFF" ><strong>审核情况</strong></td>
            <td width="80" align="center" bgcolor="#99CCFF" ><strong>操作</strong></td>
          </tr>
          <%do while not rs.eof%>
          <tr class="tdbg"> 
            <td width="47" height="22" align="center" bgcolor="#A4B6D7" class="tr_southidc"> 
              <input name='ID' type='checkbox' onClick="unselectall()" id="ID" value='<%=cstr(rs("ID"))%>'>
            </td>
            <td width="28" align="center" bgcolor="#ECF5FF" class="tr_southidc"><%=rs("ID")%></td>
            <td width="82" align="center" bgcolor="#ECF5FF" class="tr_southidc"><%=rs("Product_Id")%></td>
            <td bgcolor="#ECF5FF" class="tr_southidc">&nbsp;<a href="../ProductShow.asp?ID=<%=rs("ID")%>" target="_blank"><%=rs("title")%></a></td>
            <td width="68" align="center" bgcolor="#ECF5FF" class="tr_southidc"><%= FormatDateTime(rs("UpdateTime"),2) %></td>
            <td width="68" align="center" bgcolor="#ECF5FF" class="tr_southidc"> 
              <%if rs("Passed")=true then%>
              已审核 
            <%else%> <font color="#FF0000">未审核</font> <%end if%> </td>
            <td width="80" align="center" bgcolor="#ECF5FF" class="tr_southidc"> <a href="ProductModify.asp?ID=<%=rs("ID")%>">修改</a> 
              <a href="ProductDel.asp?ID=<%=rs("ID")%>&Action=Del" onClick="return ConfirmDel();">删除</a>            </td>
          </tr>
          <%
	i=i+1
...
%>
      ...
      <br> <table width="560" border="0" align="center" cellpadding="0" cellspacing="0" class="border">
        <tr class="tdbg"> 
