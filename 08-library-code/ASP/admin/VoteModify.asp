...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"><br>
      <br> 
      <form method="POST" action="VoteModify.asp?mark=southidc">
        <table width="560" border="0" align="center" cellpadding="2" cellspacing="1" Class="table_southidc">
          <tr align="center" class="back_southidc">
            <td height="25" colspan="4" bgcolor="#A4B6D7"><strong><b>修 改</b> 调 查</strong></td>
          </tr>
          <tr class="tdbg"> 
            <td width="15%" align="right" bgcolor="#E3E3E3">主题：</td>
...
for i=1 to 8%>
          <tr class="tdbg"> 
            <td align="right" bgcolor="#E3E3E3">选项<%=i%>：</td>
            <td bgcolor="#E3E3E3"> 
              <input name="select<%=i%>" type="text" value="<%=rs("select"& i)%>" size="36">            </td>
          ...
          <%next%>
          <tr class="tdbg"> 
            <td align="right" bgcolor="#E3E3E3">调查类型：</td>
