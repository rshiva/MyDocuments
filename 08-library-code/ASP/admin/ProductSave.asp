...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <br> 
      <br> <b> </b><br> <br> <br> 
      <table class="table_southidc" align=center width="620" border="0" cellpadding="2" cellspacing="1">
        <tr align=center bgcolor="#A4B6D7" class="back_southidc"> 
        ...
        <tr> 
          <td width="24%" height="22" bgcolor="#99CCFF" class="tdbg"> <p align="right">产品序号：</p></td>
          <td width="76%" bgcolor="#E3E3E3" class="td_southidc"><%=ID%></td>
        </tr>
        <tr> 
          <td height="22" bgcolor="#99CCFF" class="tdbg"><div align="right">产品编号：</div></td>
          <td bgcolor="#E3E3E3" class="td_southidc"><%=Product_Id%></td>
        </tr>
        <tr> 
          <td height="22" bgcolor="#99CCFF" class="tdbg"><div align="right">产品名称：</div></td>
          <td bgcolor="#E3E3E3" class="td_southidc"><%=Title%></td>
        </tr>
        <tr> 
          <td height="22" bgcolor="#99CCFF" class="tdbg"><div align="right">产品售进：</div></td>
          <td bgcolor="#E3E3E3" class="td_southidc"><%=Price%></td>
        </tr>
        <tr> 
          <td height="22" bgcolor="#99CCFF" class="tdbg"><div align="right">规格：</div></td>
          <td bgcolor="#E3E3E3" class="td_southidc"><%=Spec%></td>
        </tr>
        <tr> 
          <td height="22" bgcolor="#99CCFF" class="tdbg"><div align="right">单位：</div></td>
          <td bgcolor="#E3E3E3" class="td_southidc"><%=Unit%></td>
        </tr>
        <tr> 
          <td height="22" bgcolor="#99CCFF" class="tdbg"><div align="right">备注：</div></td>
          <td bgcolor="#E3E3E3" class="td_southidc"><%=Memo%></td>
        </tr>
        <tr> 
          <td height="22" bgcolor="#99CCFF" class="tdbg"><div align="right">所属类别：</div></td>
          <td bgcolor="#E3E3E3" class="td_southidc"> <%response.write BigClassName
		if SmallClassName<>"" then response.write " &gt;&gt; " & SmallClassName
		if SpecialName<>"" then response.write "<br>所属专题：" & SpecialName
		 %> </td>
        </tr>
        <tr> 
          <td height="22" bgcolor="#99CCFF" class="tdbg"><div align="right">关 
          键 字：</div></td>
          <td bgcolor="#E3E3E3" class="td_southidc"><%=Key%></td>
        </tr>
        <tr> 
