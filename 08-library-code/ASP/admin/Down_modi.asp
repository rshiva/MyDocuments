    ...
    <td align="center" valign="top">
      <table width="620" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <form method="POST" name="myform" onSubmit="return CheckForm();" action="Down_Save.asp?action=Modify" target="_self">
          <tr align="center"> 
            <td class="back_southidc" height="30" colspan="3"><span style="color: #000000"><strong>修改下载</strong></span></td>
          </tr>
          <tr> 
            <td width="120" height="24" align="right" bgcolor="#E3E3E3"><font color="#FF0000">*</font>下载名称：</td>
            <td colspan="2" valign="top" bgcolor="#E3E3E3">　 
              <input name="title" type="text" class="input" value="<%=rs_down("title")%>" size="30"></td>
          </tr>
          <tr> 
            <td height="24" align="right" bgcolor="#E3E3E3"><font color="#FF0000">*</font>下载类别：</td>
            <td colspan="2" valign="top" bgcolor="#E3E3E3"> 　 
              <%
        ...
        rs.close
          ...
          <tr class="back_southidc">
            <td height="19" colspan="3" align="center" valign="top" bgcolor="#ECF5FF">下载说明</td>
          </tr>
          <tr> 
            <td height="19" colspan="3" align="center" valign="top" bgcolor="#E3E3E3"><textarea name="Content" style="display:none"><%=rs_down("Content")%></textarea> 
              <iframe ID="editor" src="../editor.asp?DownClass=Down&Action=Down&ID=<%=ID%>" frameborder=1 scrolling=no width="620" height="405"></iframe></td>
          </tr>
          <tr bgcolor="#E3E3E3"> 
            <td height="24" align="right"><font color="#FF0000">*</font>适用系统：</td>
            <td colspan="2"> <input name="System" type="text" class="input" id="System" value="<%=rs_down("System")%>" size="30"></td>
          </tr>
          <tr bgcolor="#E3E3E3"> 
            <td height="24" align="right"><font color="#FF0000">*</font>软件类型：</td>
            <td colspan="2"> <input name="Softclass" type="text" class="input" id="Softclass" value="<%=rs_down("Softclass")%>" size="30"></td>
          </tr>
          <tr bgcolor="#E3E3E3"> 
            <td height="24" align="right">产品图片：</td>
            <td> <input name="PhotoUrl" type="text" id="PhotoUrl" value="<%=rs_down("PhotoUrl")%>" size="30" maxlength="200"></td>
          ...
          <tr bgcolor="#E3E3E3">
            <td height="24" align="right"><font color="#FF0000">*</font>文件大小：</td>
            <td colspan="2"> <input name="FileSize" type="text" class="input" id="fileSize" value="<%=rs_down("fileSize")%>" size="30">
              K</td>
          </tr>
          <tr bgcolor="#E3E3E3"> 
            <td height="24" align="right">录入时间：</td>
            <td colspan="2"><input name="Infotime" type="text" id="Infotime" value="<%=rs_down("Infotime")%>" maxlength="50"></td>
          </tr>
