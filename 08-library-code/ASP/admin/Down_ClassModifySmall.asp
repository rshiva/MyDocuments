  ...
  <tr> 
    <td align="center" valign="top"><table width="80%" border="0" cellpadding="0" cellspacing="0">
        <tr> 
          ...
          <br> 
          <form name="form1" method="post" action="Down_ClassModifySmall.asp">
              <p>&nbsp;</p>
              <table width="560" border="0" align="center" cellpadding="0" cellspacing="2" bgcolor="#ECF5FF" class="border">
                ...
                <tr class="tdbg"> 
                  <td height="22" bgcolor="#99CCFF"><strong>小类名称：</strong></td>
                  <td> 
