...
<table width="620" border="0" align="center" cellpadding="2" cellspacing="1" class="table_southidc">
  ...
  <tr class="tdbg"> 
    <td width="70" height="30" class="td_southidc"><strong>管理导航：</strong></td>
    <td bgcolor="#FFFFFF"><a href="Admin_Skin.asp">配色模板管理首页</a> | <a href="Admin_Skin.asp?Action=Add">添加配色模板</a> 
      | <a href="Admin_Skin.asp?Action=Export">配色模板导出</a> | <a href="Admin_Skin.asp?Action=Import">配色模板导入</a></td>
  </tr>
  <tr class="tdbg"> 
    <td width="70" height="30" class="td_southidc"><strong>模板说明：</strong></td>
    <td bgcolor="#FFFFFF">红色说明为站本站已使用了的CSS</td>
  </tr>
</table>
<%
select case Action
...
<form name="form1" method="post" action="Admin_Skin.asp">
  <table width="620" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
    <tr bgcolor="#99CCFF" class="title"> 
      <td width="32" height="30" align="center"><strong>选择</strong></td>
      <td width="31" height="30" align="center"><strong>ID</strong></td>
      <td width="95" height="30" align="center" bgcolor="#99CCFF"><strong> 模板名称</strong></td>
      <td width="129" height="30" align="center"><strong>效果图</strong></td>
      <td width="82" height="30" align="center"><strong>模板类型</strong></td>
      <td width="131" height="30" align="center"><strong> 操作</strong></td>
    </tr>
...
<form name="myform" method="post" action="Admin_Skin.asp">
  <table width="620" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
    <tr bgcolor="#FFFFFF" class="back_southidc"> 
      <td height="30" colspan="5" align="center"><strong>配色模板导出</strong></td>
    </tr>
    <tr bgcolor="#99CCFF" class="title"> 
      ...
      <td width="158" align="center" bgcolor="#99CCFF"><strong>效果图</strong></td>
...
<form name="myform" method="post" action="Admin_Skin.asp">
  <table width="620" border="0" align="center" cellpadding="2" cellspacing="1" class="table_southidc">
    <tr class="back_southidc"> 
      <td height="30" align="center"><strong>配色模板导入（第一步）</strong></td>
    </tr>
...
<form name="myform" method="post" action="Admin_Skin.asp">
  <table width="620" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
    <tr bgcolor="#FFFFFF" class="back_southidc"> 
      <td height="30" colspan="5" align="center"><strong>配色模板导入（第二步）</strong></td>
    </tr>
    <tr bgcolor="#99CCFF" class="title"> 
      ...
      <td width="150" align="center" bgcolor="#99CCFF"><strong>效果图</strong></td>
...
<form name="form1" method="post" action="Admin_Skin.asp">
  <table width="620" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
    <tr align="center" bgcolor="#FFFFFF" class="back_southidc"> 
      <td height="30" colspan="2" align="center" bgcolor="#FFFFFF"><strong> 
        <%if Action="Add" then%>
        添加新配色模板 
        <%else%>
        修改模板设置 
    ...
    <tr bgcolor="#FFFFFF" class="topbg"> 
      <td height="20" colspan="2"><strong>模板配色设置（修改以下设置必须具备一定网页知识，<span style="color: #FF0000">不能使用单引号或双引号，否则会容易造成程序错误）</span></strong></td>
    </tr>
    <tr bgcolor="#FFFFFF" class="tdbg"> 
