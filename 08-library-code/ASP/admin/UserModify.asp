    ...
    <td align="center" valign="top"> 
      <FORM name="Form1" action="UserModify.asp" method="post">
        <table width="560" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc" >
          ...
          <TR bgcolor="#FFFFFF" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><b>用 户 名：</b></TD>
            <TD class="td_southidc"> 
            <INPUT name=UserName value="<%=rsUser("UserName")%>" size=30   maxLength=14></TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><B>密码(至少6位)：</B></TD>
            <TD class="td_southidc"> 
              <INPUT   type=password maxLength=16 size=32 name=Password> 
              <font color="#FF0000">如果不想修改，请留空</font> 
            </TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><strong>密码问题：</strong></TD>
            <TD class="td_southidc"> 
              <INPUT name="Question"   type=text value="<%=rsUser("Question")%>" size=30> 
            </TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><strong>问题答案：</strong></TD>
            <TD class="td_southidc"> 
            <INPUT   type=text size=30 name="Answer"> <font color="#FF0000">如果不想修改，请留空</font></TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><strong>性别：</strong></TD>
            <TD class="td_southidc"> 
          ...
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><strong>Email地址：</strong></TD>
            <TD class="td_southidc"> 
              <INPUT name=Email value="<%=rsUser("Email")%>" size=30   maxLength=50> 
            </TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><strong>主页：</strong></TD>
            <TD class="td_southidc"> 
            <INPUT   maxLength=100 size=30 name=homepage value="<%=rsUser("HomePage")%>"></TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><strong>公司名称：</strong></TD>
            <TD class="td_southidc"> 
            <INPUT name=Comane value="<%=rsUser("CompanyName")%>" size=30 maxLength=20></TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><strong>收货地址：</strong></TD>
            <TD class="td_southidc"> 
            <INPUT name=Add value="<%=rsUser("Add")%>" size=30 maxLength=50></TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD align="right" bgcolor="#99CCFF"><strong>收货人：</strong></TD>
            <TD class="td_southidc"> 
            <INPUT name=Somane value="<%=rsUser("Receiver")%>" size=30 maxLength=50></TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD align="right" bgcolor="#99CCFF"><strong>邮政编码：</strong></TD>
            <TD class="td_southidc"> 
            <INPUT name=Zip value="<%=rsUser("Postcode")%>" size=30 maxLength=50></TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD align="right" bgcolor="#99CCFF"><strong>联系电话：</strong><br></TD>
            <TD class="td_southidc"> 
            <INPUT name=Phone value="<%=rsUser("Phone")%>" size=30 maxLength=50></TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD align="right" bgcolor="#99CCFF"><strong>传 真：</strong></TD>
            <TD class="td_southidc"> 
            <INPUT name=Fax value="<%=rsUser("Fax")%>" size=30 maxLength=50></TD>
          </TR>
          <TR bgcolor="#FFFFFF" class="tdbg" > 
            <TD width="120" align="right" bgcolor="#99CCFF"><strong>用户状态：</strong></TD>
            <TD class="td_southidc"> 
              <input type="radio" name="LockUser" value="False" <%if rsUser("LockUser")=False then response.write "checked"%>>
              正常&nbsp;&nbsp; <input type="radio" name="LockUser" value="True" <%if rsUser("LockUser")=True then response.write "checked"%>>
            锁定</TD>
          </TR>
          <TR align="center" bgcolor="#FFFFFF" class="tr_southidc" > 
