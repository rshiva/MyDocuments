...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    ...
    <table  width="560" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
        <tr> 
          <td class="back_southidc" height="30"> <div align="center"><strong>修改支付<br>
          </strong></div></td>
        </tr>
        <tr> 
          <form method="post" action="Manage_editpay.asp?no=eshop">
            <input type=hidden name=id value=<%=id%>>
            <td bgcolor="F2F8FF"><div align="center"> 
...
<div align="center">支付说明</div></td>
                    <td bgcolor="#ECF5FF"><textarea name="paymentmessage" cols="40" rows="5" id="paymentmessage"><%=rs("paymentmessage")%></textarea></td>
                  </tr>
                  <tr bgcolor="#A4B6D7"> 
