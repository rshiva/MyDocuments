...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
    <td align="center" valign="top"> <br> <strong><br>
        ...
        <tr> 
          <td class="back_southidc" height="30"> <div align="center"><strong>支付管理</strong></div></td>
        </tr>
        <tr> 
          <form method="post" action="Manage_pay.asp?mark=southidc">
            <td bgcolor="F2F8FF"> 
              <table width="100%" border="0" align="center" cellpadding="2" cellspacing="1">
                <tr> 
                  <td width="21%" height="24" bgcolor="#ECF5FF"> 
...
<textarea name="paymentmessage" cols="40" rows="5" id="paymentmessage"></textarea></td>
                ...
                <tr bgcolor="#A4B6D7" class="td_southidc"> 
                  <td height="22" colspan="2" bgcolor="#ECF5FF" class="tr_southidc"> 
                    <div align="center"> 
