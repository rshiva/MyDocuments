...
%>
        ...
        <table width="560" border="0" align="center" cellpadding="0" cellspacing="1" bgcolor="#000000" class="table_southidc">
          <tr bgcolor="#ECF5FF" class="back_southidc">
            <td height="25" colspan="7" align="center" bgcolor="#99CCFF"><span style="font-weight: bold">注册会员管理</span></td>
          </tr>
          <tr bgcolor="#ECF5FF" class="title">
            <td width="30" height="25" align="center" bgcolor="#99CCFF"><strong> 序号</strong></td>
            <td width="59" height="25" align="center" bgcolor="#99CCFF"><strong> 用户名</strong></td>
            <td width="29" height="25" align="center" bgcolor="#99CCFF"><strong> 性别</strong></td>
            <td width="87" height="25" align="center" bgcolor="#99CCFF"><strong>Email</strong></td>
            <td width="185" height="25" align="center" bgcolor="#99CCFF"><strong>公司名称</strong></td>
            <td width="39" height="25" align="center" bgcolor="#99CCFF"><strong> 状态</strong></td>
            <td width="104" height="25" align="center" bgcolor="#99CCFF"><strong> 操作</strong></td>
          </tr>
          <%do while not rs.EOF %>
          <tr class="tdbg">
