...
<form method="POST" name="myform" onSubmit="return CheckForm();" action="ProductSave.asp?action=Modify">
        <table width="620" border="0" align="center" cellpadding="2" cellspacing="1" class="table_southidc">
          ...
          <tr> 
            <td width="152" height="22" align="right" bgcolor="#E3E3E3">所属栏目：</td>
	...
	%> </td>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#E3E3E3">产品编号：</td>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#E3E3E3">产品名称：</td>
          ...
          <tr> 
            <td height="22" colspan="2" align="center" valign="middle" bgcolor="#C0C0C0" class="back_southidc">产品说明： </td>
          </tr>
          <tr bgcolor="#E3E3E3"> 
          ...
          <tr> 
            <td width="152" align="right" bgcolor="#E3E3E3">首页图片： 
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#E3E3E3">已通过审核：</td>
          ...
          <tr> 
            <td height="22" align="right" bgcolor="#E3E3E3">录入时间：</td>
