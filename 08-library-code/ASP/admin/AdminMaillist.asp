...
<table width="760" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
  ...
  <tr bgcolor="#FFFFFF" class="tdbg"> 
    <td width="101" height="30" bgcolor="#e3e3e3" class="td_southidc"><div align="right">管理导航：</div></td>
...
<form method="POST" action="AdminMaillist.asp?Action=Send">
  <table width="760" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" Class="table_southidc">
    ...
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td rowspan="3" align="right" bgcolor="#e3e3e3" class="td_southidc">收件人：</td>
      <td width="85%"> 
    ...
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td width="15%" align="right" bgcolor="#e3e3e3" class="td_southidc">邮件主题：</td>
      <td width="85%"> 
        <input type=text name=subject size=64>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td align="right" bgcolor="#e3e3e3" class="td_southidc">邮件内容：</td>
      <td> 
        <textarea cols=80 rows=8 name="content"></textarea>
      </td>
    </tr>
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td width="15%" align="right" bgcolor="#e3e3e3" class="td_southidc">发件人：</td>
      <td width="85%"> 
        <input type="text" name="sendername" size="64" value="<%=SiteName%>">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td width="15%" align="right" bgcolor="#e3e3e3" class="td_southidc">发件人Email：</td>
      <td width="85%"> 
        <input type="text" name="senderemail" size="64" value="<%=WebMasterEmail%>">
      </td>
    </tr>
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td align="right" bgcolor="#e3e3e3" class="td_southidc">邮件优先级：</td>
      <td> 
    ...
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td width="15%" align="right" bgcolor="#e3e3e3" class="td_southidc">注意事项：</td>
      <td width="85%"> 
        <%
...
<form method="POST" action="AdminMaillist.asp?Action=DoExport">
  <table width="760" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" Class="table_southidc">
    ...
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td width="24%" height="80" align="right" bgcolor="#e3e3e3" class="td_southidc">导出邮件列表到数据库：</td>
