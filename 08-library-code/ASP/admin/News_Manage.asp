    ...
    <td align="center" valign="top"> <br> 
      ...
      <table width="620" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
        <tr bgcolor="#A4B6D7" class="back_southidc">
          <td height="25" align="center"><strong>新 
        闻  管 理</strong></td>
        </tr>
        <tr class="title"> 
...
%>
      ...
      <form name="del" method="Post" action="News_Del.asp" onSubmit="return ConfirmDel();">
        <table width="620" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
          <tr bgcolor="#A4B6D7"> 
            <td height="25"><a href="News_Manage.asp">&nbsp;新闻管理</a> &gt;&gt; 
            <%
...
sub showContent
    ...
    i=0
%>
        <table width="620" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc" style="word-break:break-all">
          ...
          <tr class="tr_southidc"> 
            ...
            <td><a href="../Shownews.asp?ID=<%=rs("id")%>" target="_blank"><%=left(rs("title"),18)%></a></td>
            <td>
<div align="center"><%=rs("BigClassName")%></div></td>
            <td>
<div align="center"><%=rs("SmallClassName")%></div></td>
            <td align="center"><%= FormatDateTime(rs("infotime"),2) %> </td>
            <td width="68" align="center"> <a href="News_modi.asp?ID=<%=rs("id")%>">修改</a> 
...
%>
      ...
      <br> <table width="560" border="0" cellpadding="0" cellspacing="0" class="border">
        <tr class="tdbg"> 
