...
<table width="760" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" Class="table_southidc">
  <tr> 
    <td class="back_southidc" height="30" colspan=2 align=center><strong>友 情 链 
      接 管 理</strong></td>
  </tr>
  <tr bgcolor="#FFFFFF" class="tdbg"> 
    <td width="77" height="30" align="center" class="td_southidc"><strong>管理导航：</strong></td>
...
<table width="760" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" Class="table_southidc">
  <tr bgcolor="#FFFFFF" class="title"> 
    <td width="72" height="22" align="center" class="tr_southidc">链接类型</td>
      
    <td width="74" height="22" align="center" class="tr_southidc">网站名称</td>
      
    <td width="73" height="22" align="center" class="tr_southidc">网站LOGO</td>
      
    <td width="139" height="22" align="center" class="tr_southidc">网站简介</td>
      
    <td width="57" height="22" align="center" class="tr_southidc">站长</td>
      
    <td width="48" height="22" align="center" class="tr_southidc">状态</td>
      
    <td width="101" height="22" align="center" class="tr_southidc">操作</td>
  </tr>
<%
do while not rs.eof
%>
...
<form method="post" name="AddLink" onSubmit="return Check()" action="Admin_FriendLinks.asp">
  <table width="760" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
    <tr bgcolor="#FFFFFF" class="back_southidc"> 
      <td height="22" colspan="2" align="center"><strong>添加友情链接</strong></td>
    </tr>
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td width="300" height="25" class="td_southidc"><strong>链接类型：</strong></td>
      <td height="25"> 
    ...
    <tr bgcolor="#FFFFFF" class="tdbg"> 
      <td width="300" height="25" class="td_southidc"><strong>审核通过：</strong></td>
      <td height="25" valign="middle"> 
