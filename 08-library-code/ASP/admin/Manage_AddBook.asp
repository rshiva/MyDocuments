          ...
          <form method="POST" action="Manage_AddBook.asp?mark=southidc">
            ...
            <td><div align="center"> 
                <table width="100%" border="0" cellpadding="2" cellspacing="1" class="table_southidc">
                  <tr bgcolor="#A4B6D7"> 
                    <td width="27%" height="25" bgcolor="#E3E3E3"> 
                    <div align="center">标&nbsp;&nbsp;题</div></td>
                    <td width="73%" bgcolor="#E3E3E3"> 
...
<textarea rows="8" name="Content" cols="45"></textarea>                    </td>
				...
				<table width="100%" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
                  <tr bgcolor="#99CCFF"> 
                    <td width="63%" height="25"> <div align="center">公告标题</div>
                  ...
                  <% do while not Rs.eof %>
                  <tr bgcolor="#ECF5FF"> 
                    <td height="25" bgcolor="#ECF5FF"> <div align="center"> <%=rs("Title")%></div>
                    <div align="center"></div></td>
                    <td height="25"> <div align="center"><%= FormatDateTime(rs("time"),2) %></div></td>
                    <td height="25"> <div align="center"><a href="Manage_editBook.asp?id=<%=Rs("id")%>">修改</a></div></td>
                    <td height="25"> <div align="center"><a href="Manage_AddBook.asp?id=<%=Rs("id")%>&amp;no=yes">删除</a></div></td>
                  </tr>
                  <%Rs.MoveNext 
loop 
%>
