...
<tr class=back_southidc><td height=25 align="center" class=td style="font-weight: bold">访问明细统计（日期：<%=action%>）</td>
</tr>
<tr><td bgcolor="#FFFFFF">
  <table width="100%" border="0" cellPadding=2 cellSpacing=1 bordercolorlight="#C0C0C0" bordercolordark="#FFFFFF" class="table_southidc">
  <tr bgcolor="#99CCFF">
    <td height="25" bgcolor="#99CCFF">来访时间</td>
    <td height="25" bgcolor="#99CCFF">来访IP</td>
    <td height="25" bgcolor="#99CCFF">从何处而来</td>
  </tr>
...
%>
  ...
  <tr>
	<td height="25" bgcolor="#FFFFFF"><%=rs("times")%></td>
	<td height="25" bgcolor="#FFFFFF"><a href="city.asp?ip=<%=rs("ip")%>" target=_blank alt='点击查看来源'><%=rs("ip")%></a></td>
...
<table width="90%" border="0" align="center">
  <tr>
    <td><input name="button" type="button" onClick="javascript:location.href='javascript:history.go(-1)';" value="返回上一页"></td>
  </tr>
</table>
<br>
</body></html>
