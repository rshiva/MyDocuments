  ...
  <tr> 
    <td align="center" valign="top"> <br>
      ...
      <table width="620" border="0" align="center" cellpadding="2" cellspacing="1">
        <tr>
          <td height="25" align="center"><strong>产 
        品 审 核</strong></td>
        </tr>
      </table>
...
%>
      ...
      <form action="ProductCheckSet.asp" method="Post" name="Check" id="Check">
        <table width="620" height="22" border="0" cellpadding="2" cellspacing="1" bgcolor="#000000" class="table_southidc">
          <tr bgcolor="#99CCFF"> 
            <td width="453" height="22"><a href="ProductCheck.asp">&nbsp;产品审核</a>&nbsp;&gt;&gt;&nbsp; 
            <%
...
%>
        <table width="620" border="0" cellpadding="2" cellspacing="1" class="table_southidc" style="word-break:break-all">
          ...
          <tr class="tr_southidc"> 
            ...
            <td width="37" align="center"><%=rs("ID")%></td>
            <td> <a href="../ProductShow.asp?ID=<%=rs("ID")%>" title="<%=replace(left(nohtml(rs("Content")),200),chr(34),"") & "……"%>">&nbsp;<%=rs("title")%></a></td>
            <td width="63" align="center"><%= FormatDateTime(rs("UpdateTime"),2) %></td>
            <td width="57" align="center"><%=rs("Hits")%> </td>
