...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr> 
            ...
            <form name="form2" method="post" action="News_ClassAddSmall.asp" onSubmit="return checkSmall()">
              <table width="560" border="0" align="center" cellpadding="2" cellspacing="1" class="table_southidc">
                <tr bgcolor="#A4B6D7" class="back_southidc"> 
                  <td height="25" colspan="2" align="center"><strong>添加新闻小类</strong></td>
                </tr>
                <tr class="tdbg"> 
                  <td width="126" height="22" bgcolor="#99CCFF"><div align="center"><strong>所属大类：</strong></div></td>
	...
	%>
                ...
                <tr class="tdbg"> 
                  <td width="126" height="22" bgcolor="#99CCFF"><div align="center"><strong>小类名称：</strong></div></td>
                  <td class="td_southidc"> <input name="SmallClassName" type="text" size="20" maxlength="30"></td>
                </tr>
