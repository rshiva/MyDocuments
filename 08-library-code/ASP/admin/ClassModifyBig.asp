    ...
    <br> 
      <br> <br> <form name="form1" method="post" action="ClassModifyBig.asp">
        <table width="560" border="0" align="center" cellpadding="2" cellspacing="1" bgcolor="#ECF5FF" class="table_southidc">
          ...
          <tr class="tdbg"> 
            <td width="126" height="20" align="center" bgcolor="#99CCFF"><strong>大类名称：</strong></td>
            <td width="204" class="td_southidc"> 
              <input name="NewBigClassName" type="text" id="NewBigClassName" value="<%=rs("BigClassName")%>" size="20" maxlength="30">            </td>
          </tr>
          <tr class="tdbg"> 
            <td align="center" bgcolor="#A4B6D7" class="td_southidc">&nbsp;</td>
