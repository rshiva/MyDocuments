...
for (i = 1; i <= 100; i++)
{
    _root.loader.attachMovie("dot", "dotM" + i, i + 200);
    loader["dotM" + i]._x = 100;
    loader["dotM" + i]._y = -50;
} // end of for
_root.onEnterFrame = function ()
{
    if (preloader < 100)
    {
        ...
        {
            loader["dotM" + i].xSlideTo(Math.round(preloader) * 2 - 3, 7.000000E-001, "easeoutexpo");
            loader["dotM" + i].ySlideTo(0, 7.000000E-001, "easeoutexpo");
            loader["dotM" + i].alphaTo(100, 1, "easeoutexpo");
        } // end of for
        loaded = preloader;
        preloader = preloader + 4.000000E-001;
    }
    else
    {
        gotoAndStop("home");
