...
class sIFR {
  public static var DEFAULT_TEXT                 = 'Rendered with sIFR 3, revision 432<br><strong>Rendered with sIFR 3, revision 432</strong><br><em>Rendered with sIFR 3, revision 432</em><br><strong><em>Rendered with sIFR 3, revision 432</em></strong>';
  ...
  public static function run(delayed) {
    ...
    if(checkVersion && _root.version != VERSION) content = VERSION_WARNING + _root.version;
