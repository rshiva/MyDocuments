...
while (i <= 8)
{
    topLink[i] = _root["topLinkSrc" + i];
    ++i;
} // end while
var extraLink = new Array();
var i = 1;
while (i <= 7)
{
    extraLink[i] = _root["extraLinkSrc" + i];
    ++i;
} // end while
_root.active = undefined;
_root.subActive = undefined;
function onActivated(prop, oldVal, newVal, speedLimit)
{
    if (newVal == "false")
    {
        form.gotoAndStop(1);
        form.comboSearch.gotoAndStop(1);
        form.titleT.txt.text = _root.titleText;
        form.goLink = undefined;
    } // end if
} // End of the function
...
_global.findTweenValue = function (_propStart, _propDest, _timeStart, _timeNow, _timeDest, _animType, _extra1, _extra2)
{
    ...
    switch (_animType.toLowerCase())
    {
        ...
        {
            _loc1 = _loc1 / _loc3;
            return (_loc2 * (_loc1 / _loc3) * _loc1 + _loc4);
        } 
        case "easeoutquad":
        {
            _loc1 = _loc1 / _loc3;
            return (-_loc2 * (_loc1 / _loc3) * (_loc1 - 2) + _loc4);
        } 
        case "easeinoutquad":
        {
            _loc1 = _loc1 / (_loc3 / 2);
        ...
        {
            _loc1 = _loc1 / _loc3;
            return (_loc2 * (_loc1 / _loc3) * _loc1 * _loc1 + _loc4);
        } 
        case "easeoutcubic":
        {
            _loc1 = _loc1 / _loc3 - 1;
            return (_loc2 * ((_loc1 / _loc3 - 1) * _loc1 * _loc1 + 1) + _loc4);
        } 
        case "easeinoutcubic":
        {
            _loc1 = _loc1 / (_loc3 / 2);
            ...
            _loc1 = _loc1 - 2;
            return (_loc2 / 2 * ((_loc1 - 2) * _loc1 * _loc1 + 2) + _loc4);
        } 
        case "easeoutincubic":
        {
            if (_loc1 < _loc3 / 2)
        ...
        {
            _loc1 = _loc1 / _loc3;
            return (_loc2 * (_loc1 / _loc3) * _loc1 * _loc1 * _loc1 + _loc4);
        } 
        case "easeoutquart":
        {
            _loc1 = _loc1 / _loc3 - 1;
            return (-_loc2 * ((_loc1 / _loc3 - 1) * _loc1 * _loc1 * _loc1 - 1) + _loc4);
        } 
        case "easeinoutquart":
        {
            _loc1 = _loc1 / (_loc3 / 2);
            ...
            _loc1 = _loc1 - 2;
            return (-_loc2 / 2 * ((_loc1 - 2) * _loc1 * _loc1 * _loc1 - 2) + _loc4);
        } 
        case "easeoutinquart":
        {
            if (_loc1 < _loc3 / 2)
        ...
        {
            _loc1 = _loc1 / _loc3;
            return (_loc2 * (_loc1 / _loc3) * _loc1 * _loc1 * _loc1 * _loc1 + _loc4);
        } 
        case "easeoutquint":
        {
            _loc1 = _loc1 / _loc3 - 1;
            return (_loc2 * ((_loc1 / _loc3 - 1) * _loc1 * _loc1 * _loc1 * _loc1 + 1) + _loc4);
        } 
        case "easeinoutquint":
        {
            _loc1 = _loc1 / (_loc3 / 2);
            ...
            _loc1 = _loc1 - 2;
            return (_loc2 / 2 * ((_loc1 - 2) * _loc1 * _loc1 * _loc1 * _loc1 + 2) + _loc4);
        } 
        case "easeoutinquint":
        {
            if (_loc1 < _loc3 / 2)
        ...
        {
            _loc1 = _loc1 / _loc3;
            return (-_loc2 * (Math.sqrt(1 - _loc1 / _loc3 * _loc1) - 1) + _loc4);
        } 
        case "easeoutcirc":
        {
            _loc1 = _loc1 / _loc3 - 1;
            return (_loc2 * Math.sqrt(1 - (_loc1 / _loc3 - 1) * _loc1) + _loc4);
        } 
        case "easeinoutcirc":
        {
            _loc1 = _loc1 / (_loc3 / 2);
            ...
            _loc1 = _loc1 - 2;
            return (_loc2 / 2 * (Math.sqrt(1 - (_loc1 - 2) * _loc1) + 1) + _loc4);
        } 
        case "easeoutincirc":
        {
            if (_loc1 < _loc3 / 2)
        ...
        case "easeinelastic":
        {
            ...
            _loc1 = _loc1 - 1;
            return (-_loc6 * Math.pow(2, 10 * (_loc1 - 1)) * Math.sin((_loc1 * _loc3 - _loc5) * 6.283185E+000 / _loc7) + _loc4);
        } 
        case "easeoutelastic":
        {
            if (_loc1 == 0)
        ...
        case "easeinoutelastic":
        {
            ...
            {
                _loc1 = _loc1 - 1;
                return (-5.000000E-001 * (_loc6 * Math.pow(2, 10 * (_loc1 - 1)) * Math.sin((_loc1 * _loc3 - _loc5) * 6.283185E+000 / _loc7)) + _loc4);
            } // end if
            _loc1 = _loc1 - 1;
            return (_loc6 * Math.pow(2, -10 * (_loc1 - 1)) * Math.sin((_loc1 * _loc3 - _loc5) * 6.283185E+000 / _loc7) * 5.000000E-001 + _loc2 + _loc4);
        } 
        ...
        case "easeinback":
        {
            ...
            _loc1 = _loc1 / _loc3;
            return (_loc2 * (_loc1 / _loc3) * _loc1 * ((_loc5 + 1) * _loc1 - _loc5) + _loc4);
        } 
        case "easeoutback":
        {
            if (_loc5 == undefined)
            ...
            _loc1 = _loc1 / _loc3 - 1;
            return (_loc2 * ((_loc1 / _loc3 - 1) * _loc1 * ((_loc5 + 1) * _loc1 + _loc5) + 1) + _loc4);
        } 
        case "easeinoutback":
        {
            if (_loc5 == undefined)
            ...
            if (_loc1 / (_loc3 / 2) < 1)
            {
                ...
                return (_loc2 / 2 * (_loc1 * _loc1 * ((_loc5 * 1.525000E+000 + 1) * _loc1 - _loc5)) + _loc4);
            } // end if
            _loc1 = _loc1 - 2;
            _loc5 = _loc5 * 1.525000E+000;
            return (_loc2 / 2 * ((_loc1 - 2) * _loc1 * ((_loc5 * 1.525000E+000 + 1) * _loc1 + _loc5) + 2) + _loc4);
        } 
        case "easeoutinback":
        {
            if (_loc1 < _loc3 / 2)
        ...
        case "easeoutbounce":
        {
            ...
            else if (_loc1 < 7.272727E-001)
            {
                ...
                return (_loc2 * (7.562500E+000 * (_loc1 - 5.454545E-001) * _loc1 + 7.500000E-001) + _loc4);
            }
            else if (_loc1 < 9.090909E-001)
            {
                _loc1 = _loc1 - 8.181818E-001;
                return (_loc2 * (7.562500E+000 * (_loc1 - 8.181818E-001) * _loc1 + 9.375000E-001) + _loc4);
            }
            else
            {
                _loc1 = _loc1 - 9.545455E-001;
                return (_loc2 * (7.562500E+000 * (_loc1 - 9.545455E-001) * _loc1 + 9.843750E-001) + _loc4);
            } // end else if
        } 
...
MovieClip.prototype.smtM = function (pos, wht, spd, batterSmt)
{
    if (batterSmt == true)
    {
        whtIf = this[wht];
    ...
    {
        whtIf = Math.floor(this[wht]);
        posIf = Math.floor(pos);
    } // end else if
    if (this[wht] == pos)
    {
        this[wht] = pos;
    ...
    {
        this[wht] = this[wht] + (pos - this[wht]) * spd;
    }
    else if (this[wht] != pos)
    {
        this[wht] = pos;
    } // end else if
};
MovieClip.prototype.smt = function (pos, wht, spd, qul)
{
    this.onEnterFrame = function ()
    {
        if (Math.floor(this[wht]) != Math.floor(pos))
        {
            this[wht] = this[wht] + (pos - this[wht]) * spd;
        }
        else if (this[wht] != pos)
...
var eVal = 0;
MovieClip.prototype.elaM = function (pos, wht, rag, spd)
{
    eVal = eVal * rag + (pos - this[wht]) * spd;
    this[wht] = this[wht] + eVal;
};
MovieClip.prototype.ovrM = function (val, spd)
{
    if (!spd || spd == "")
    {
        spd = 2;
...
MovieClip.prototype.ovr = function (val, spd)
{
    if (!spd || spd == "")
    {
        spd = 2;
...
MovieClip.prototype.alpM = function (val, num, spd)
{
    if (!num)
    {
        num = 70;
...
MovieClip.prototype.alp = function (val, num, spd)
{
    if (!num)
    {
        num = 70;
...
MovieClip.prototype.blurImg = function (val, num, scl, alp)
{
    if (this.cnt == null)
    {
        this.cnt = 1;
    ...
    this.onEnterFrame = function ()
    {
        var _loc2 = new flash.filters.BlurFilter(this.cnt, this.cnt, 3);
        _loc2.quality = 2;
        var _loc3 = new Array();
        _loc3.push(_loc2);
        this.filters = _loc3;
        this._alpha = 100 - this.cnt * alp;
        if (val == true)
        {
            ++this.cnt;
        }
...
MovieClip.prototype.drawBMP = function (bool, trgMc)
{
    if (bool)
    {
        trgMc._visible = false;
        if (trgMc == _level0.sub01Load_mc)
        {
            oldX = trgMc._x;
            oldY = trgMc._y;
            trgMc._x = -5000;
            ...
            trgMc._xscale = 1;
            trgMc._yscale = 1;
            trgMc.m_mc.m3d_ns.pause(true);
        } // end if
        bmpd = new flash.display.BitmapData(2000, 1200, true, 16777215);
        bmpd_mc = trgMc._parent.createEmptyMovieClip("bmpd_mc", this.getNextHighestDepth());
        bmpd_mc.attachBitmap(bmpd, this.getNextHighestDepth());
        rage = 500;
        bmpd_mc._x = -rage;
        bmpd_mc._y = -rage + 300;
        ...
        matrix.tx = rage;
        matrix.ty = rage - 300;
        bmpd.draw(trgMc, matrix);
        var _loc5 = 4;
        var _loc4 = 4;
        var _loc3 = 1;
        filter = new flash.filters.BlurFilter(_loc5, _loc4, _loc3);
        bmpd.applyFilter(bmpd, bmpd.rectangle, new flash.geom.Point(0, 0), filter);
    }
    else
    {
        bmpd.dispose();
        if (trgMc == _level0.sub01Load_mc)
        {
            ...
            trgMc._xscale = 100;
            trgMc._yscale = 100;
            trgMc.m_mc.m3d_ns.pause(false);
        } // end if
        trgMc._visible = true;
    } // end else if
};
MovieClip.prototype.mcLoad = function (ldmc, loading, loadX, loadY)
{
    ...
    _loc2.onLoadStart = function (target_mc)
    {
        ...
        {
            target_mc.loadPer = 0;
            _level400.gotoAndStop(1);
            _level400.loadOn(target_mc, loadX, loadY);
        } // end if
    };
    _loc2.onLoadProgress = function (target_mc, bytesLoaded, bytesTotal)
    {
        if (loading == true)
        {
            loadPer = bytesLoaded / bytesTotal * 100;
            if (bytesLoaded == bytesTotal)
            {
                target_mc.loadPer = 100;
                target_mc.loadOk = true;
            }
            else
            {
                target_mc.loadPer = loadPer;
                target_mc.loadOk = false;
            } // end else if
        }
    ...
    _loc3.loadClip(ldmc, this);
};
var serchText = new Array();
var serchLink = new Array();
var titleText;
var searchLink;
if (_root._url.substring(0, 1) == "f")
{
    titleText = "?????? ??????";
    ...
    while (i <= 5)
    {
        serchText[i] = "JO ANNA SMITH ??" + i;
        serchLink[i] = "http://www.naver.com";
        ++i;
    } // end while
}
else
{
    titleText = _root.titleTxt;
    searchLink = _root.searchLink;
    var i = 1;
    while (i <= 5)
    {
        serchText[i] = _root["txt" + i];
        serchLink[i] = _root["link" + i];
        ++i;
    } // end while
} // end else if
form.titleT.txt.text = titleText;
var activated = "true";
this.watch("activated", onActivated);
